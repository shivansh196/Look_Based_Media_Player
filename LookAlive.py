...
class Window (QWidget):
    ...
    def init_ui(self):
        ...
        faceDetetction.setStyleSheet("color: black; font-size: 16px; background-color: white;" "border-radius: 10px; padding: 10px; text-align: center; ")
        faceDetetction.clicked.connect(self.FaceDetection)

        # Create Open button
        openBtn = QPushButton('Open Video File')
        openBtn.clicked.connect(self.open_file)
        openBtn.setStyleSheet("QPushButton::pressed""{""background-color : white;""}")
        openBtn.setStyleSheet("color: black; font-size: 16px; background-color: white; border-radius: 10px;"" padding: 10px; text-align: center;")
        ...
        hboxlayout.addWidget(faceDetetction)
